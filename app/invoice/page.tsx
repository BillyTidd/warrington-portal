...
import { Loader2, MoreHorizontal, Pen, Trash } from "lucide-react";
...
export default function InvoicesPage() {
  ...
  const [deletingClient, setDeletingClient] = useState<Invoice | null>(null);
  ...
  const handleDeleteClient = async () => {
    ...
    try {
      const response = await fetch(
        `/api/create-invoice/${deletingClient._id}`,
        {
          method: "DELETE",
        }
      );
